...
namespace Core.Persistence.Configurations
{
    public class LogConfiguration : BaseConfiguration<Log, Guid>
    {
        public override void Configure(EntityTypeBuilder<Log> builder)
        {
            ...
            builder.Property(x => x.Headers).IsRequired(false).HasColumnName("Headers").HasColumnType("text");
            builder.Property(x => x.ResponseHeaders).IsRequired(false).HasColumnName("ResponseHeaders").HasColumnType("text");
            builder.Property(x => x.RequestMethod).IsRequired(false).HasColumnName("RequestMethod").HasColumnType("text");
            builder.Property(x => x.UserAgent).IsRequired(false).HasColumnName("UserAgent").HasColumnType("text");
            builder.Property(x => x.RequestBody).IsRequired(false).HasColumnName("RequestBody").HasColumnType("text");
            builder.Property(x => x.ResponseBody).IsRequired(false).HasColumnName("ResponseBody").HasColumnType("text");
            builder.Property(x => x.Exception).IsRequired(false).HasColumnName("Exception").HasColumnType("text");
            builder.Property(x => x.ExceptionMessage).IsRequired(false).HasColumnName("ExceptionMessage").HasColumnType("text");
            builder.Property(x => x.InnerException).IsRequired(false).HasColumnName("InnerException").HasColumnType("text");
